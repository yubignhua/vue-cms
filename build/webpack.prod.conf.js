...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  output: {
    ...
    //filename     : 'static/vue_cdm/[name].min.[chunkhash].js',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: process.env.NODE_ENV === 'testing' ? 'index.html' : config.build.index,//config.build.index => path.resolve(__dirname, '../dist/index.html'),
      template: 'index.html',
      inject: true,
      minify: {
        // 删除index.html中的注释
    ...
    //     to: config.build.assetsSubDirectory,//assetsSubDirectory => 'static/vue'
    //     ignore: ['.*']
    //   }
    // ])
  ]
