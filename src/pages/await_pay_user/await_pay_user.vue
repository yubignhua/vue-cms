      ...
      <el-tab-pane label="血压用户" name="first">
        <div class="user-base-info">
          ...
          <el-footer style="background: white;border-top: solid 1px #f4f4f4;">
            ...
            <el-pagination :page-size="pageSize" background layout="prev, pager, next" :current-page="curPage" @current-change="handleCurrentChange" :total="allPageNum"></el-pagination>
          </el-footer>
